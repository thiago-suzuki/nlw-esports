...
export function CreateAdModal() {
    ...
    function handleCreateAd(event: FormEvent) {
        ...
        try {
            axios.post(`${url}/games/${data.game}/ads`, {
                name: data.name,
    ...
    return (
        ...
        <Dialog.Content className='fixed bg-[#2A2634] py-8 p-10 text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-lg w-[486px] shadow-lg shadow-black/25'>
          ...
          <form onSubmit={handleCreateAd}  className='mt-6 flex flex-col gap-4'>
            <div className='flex flex-col gap-2'>
              ...
              <select
                ...
                id="game" 
                placeholder='Selecine o game que deseja jogar'
                defaultValue=""
              >
